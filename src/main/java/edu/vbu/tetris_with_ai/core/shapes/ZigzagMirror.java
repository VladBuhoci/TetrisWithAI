 ...
 * </pre>
 */
public class ZigzagMirror extends Shape {

    private static final List<Position> occupiedCellPositionsUpOrient = Arrays.asList(
            new Position(0, 1), new Position(0, 2),  // first row
